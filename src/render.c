...
/*   Updated: 2025/06/09 15:43:54 by vpushkar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// {
// 	game->textures.floor_tx_tl_f = mlx_load_png("textures/png/floor/floor_tl_f.png");
// 	game->textures.floor_tx_tr_f = mlx_load_png("textures/png/floor/floor_tr_f.png");
// 	game->textures.floor_tx_bl_f = mlx_load_png("textures/png/floor/floor_bl_f.png");
// 	game->textures.floor_tx_br_f = mlx_load_png("textures/png/floor/floor_br_f.png");
// 	game->textures.floor_tx_top = mlx_load_png("textures/png/floor/floor_t.png");
// 	game->textures.floor_tx_b = mlx_load_png("textures/png/floor/floor_b_f.png");
...
// {
// 	if (mask == (TOP | LEFT))
// 		return (game->textures.floor_tx_tl_f);
// 	else if (mask == (TOP | RIGHT))
// 		return (game->textures.floor_tx_tr_f);
// 	else if (mask == (BOTTOM | LEFT))
// 		return (game->textures.floor_tx_bl_f);
// 	else if (mask == (BOTTOM | RIGHT))
// 		return (game->textures.floor_tx_br_f);
// 	else if (mask == TOP)
...
// {
// 	mlx_delete_texture(tx->floor_tx_tl_f);
// 	mlx_delete_texture(tx->floor_tx_tr_f);
// 	mlx_delete_texture(tx->floor_tx_bl_f);
// 	mlx_delete_texture(tx->floor_tx_br_f);
